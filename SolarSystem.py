...
pygame.display.set_caption("Kunwar's - Solar System Visualizer")

# Load the images for each planet
sun_image = pygame.image.load(os.path.join("planets", "C:/Users/kunwa/Python/Projects/solar-system-visualizer/planets/sun.png"))
mercury_image = pygame.image.load(os.path.join("planets", "C:/Users/kunwa/Python/Projects/solar-system-visualizer/planets/mercury.png"))
venus_image = pygame.image.load(os.path.join("planets", "C:/Users/kunwa/Python/Projects/solar-system-visualizer/planets/venus.png"))
earth_image = pygame.image.load(os.path.join("planets", "C:/Users/kunwa/Python/Projects/solar-system-visualizer/planets/earth.png"))
mars_image = pygame.image.load(os.path.join("planets", "C:/Users/kunwa/Python/Projects/solar-system-visualizer/planets/mars.png"))
jupiter_image = pygame.image.load(os.path.join("planets", "C:/Users/kunwa/Python/Projects/solar-system-visualizer/planets/jupiter.png"))
saturn_image = pygame.image.load(os.path.join("planets", "C:/Users/kunwa/Python/Projects/solar-system-visualizer/planets/saturn_ring.png"))
uranus_image = pygame.image.load(os.path.join("planets", "C:/Users/kunwa/Python/Projects/solar-system-visualizer/planets/uranus.png"))
neptune_image = pygame.image.load(os.path.join("planets", "C:/Users/kunwa/Python/Projects/solar-system-visualizer/planets/neptune.png"))

# Load the background image
background_image = pygame.image.load(os.path.join("planets", "C:/Users/kunwa/Python/Projects/solar-system-visualizer/planets/space.png"))
